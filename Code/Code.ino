...
#define KEY     "bbbbbbbbbbbbb"      //GearKey from NetPie e.g. "4DPanXKaSdb2VrT"
#define SECRET  "ccccccccccccccccccY"   //GearSecret from NetPie e.g. "ZgrXbHsaVp7TI8xW5oEcAqvY3"
...
void updateIO() {
  if (state & B00000001)digitalWrite(LEDPIN1, HIGH);else digitalWrite(LEDPIN1, LOW);
  if (state & B00000010)digitalWrite(LEDPIN2, HIGH);else digitalWrite(LEDPIN2, LOW);
  if (state & B00000100)digitalWrite(LEDPIN3, HIGH);else digitalWrite(LEDPIN3, LOW); 
  if (state & B00001000)digitalWrite(LEDPIN4, HIGH);else digitalWrite(LEDPIN4, LOW);   
}
